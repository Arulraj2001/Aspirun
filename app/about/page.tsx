    ...
    <Container size="md" className="py-8 md:py-16 space-y-8">
      <div className="text-center space-y-4">
        <h1 className="text-3xl md:text-5xl font-black text-surface-900 tracking-tight">
          About <span className="text-brand-500">StudySetu</span>
        </h1>
      ...
      <Card className="border border-surface-200 p-6 md:p-8 space-y-6">
        <p className="text-xs md:text-sm text-surface-650 leading-relaxed font-semibold">
          StudySetu is India&apos;s leading platform designed specifically for government exam aspirants. We specialize in structuring daily target-based study plans for exams like UPSC CSE, SSC CGL, RRB NTPC, IBPS PO, and State Constable Recruitments.
        </p>

        <h3 className="text-sm md:text-base font-black text-surface-850">Our Vision</h3>
        <p className="text-xs md:text-sm text-surface-650 leading-relaxed font-semibold">
          For millions of aspirants, passing a government exam is a life-changing milestone. However, the volume of syllabus materials can feel overwhelming. StudySetu makes the journey manageable by breaking down complex exam requirements into clear, day-by-day task lists, practice sets, and mock assessments.
        </p>
